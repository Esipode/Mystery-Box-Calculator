	...
	render() {
		return (
			<div className="header">
				<div className="backStep" onClick={() => this.onStepButton(-1)} style={{display: this.props.curStep > 0 ? 'flex' : 'none'}}>
					<div>
				...
				<div className="forwardStep" onClick={() => this.onStepButton(+1)} style={this.onCheckStepVisibility(this.props.curStep)}>
